...
declare module '@mapbox/mapbox-sdk/services/directions' {
  ...
  interface DirectionsService {
      getDirections(request: DirectionsRequest): MapiRequest<DirectionsResponse>;
      getDirections(request: DirectionsRequest<'polyline' | undefined>): MapiRequest<DirectionsResponse<string>>;
      getDirections(request: DirectionsRequest<'polyline6'>): MapiRequest<DirectionsResponse<string>>;
  ...
  interface CommonDirectionsRequest<T extends DirectionsGeometry = undefined> {
  ...
  type DirectionsRequest<T extends DirectionsGeometry> = CommonDirectionsRequest<T> & DirectionsProfileExclusion;
  ...
  type RouteGeometry = GeoJSON.LineString | GeoJSON.MultiLineString | string

  interface DirectionsResponse<T> {
      /**
...
declare module '@mapbox/mapbox-sdk/services/geocoding' {
  ...
  interface GeocodeFeature extends GeoJSON.Feature<GeoJSON.Point & { interpolated: boolean; }, GeocodeProperties> {
      /**
